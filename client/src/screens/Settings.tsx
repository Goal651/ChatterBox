...
export default function Setting({ userData, serverUrl, loadedImage, photos }: { userData: User | null; serverUrl: string, loadedImage: (data: Photos) => void, photos: Photos[] }) {
    ...
    return (
        <div className="w-full flex flex-col items-center p-8 space-y-10 bg-gradient-to-br from-gray-950 via-gray-900 to-gray-950 min-h-screen shadow-2xl overflow-y-auto overflow-x-hidden">
