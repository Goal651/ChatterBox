...
export default function Navigator({ initialCurrentUser, socket, mediaType, serverUrl, loadedImage, photos }: NavigatorProps) {
    ...
    return (
        ...
        >
            ...
            <div
                className={`flex ${isMobile ? "justify-evenly" : "justify-center space-y-2 flex-col"} md:space-y-4 lg:space-y-8 xl:space-y-14`}
            >
                <div onClick={() => navigate("/")} className="flex space-x-4 cursor-pointer">
                ...
                <div onClick={() => navigate("/chat")} className="flex space-x-4 cursor-pointer">
                    <div className="w-8 h-8">
                ...
                <div onClick={() => navigate("/notification")} className="flex space-x-4 cursor-pointer">
                    <div className="w-8 h-8">
                ...
                <div onClick={() => navigate("/setting")} className="flex space-x-4 cursor-pointer">
                    <div className="w-8 h-8">
