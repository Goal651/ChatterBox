...
export default function Messages({
    ...
    if (isLoading) {
        return (
            <div className="h-full flex flex-col items-center justify-center bg-transparent rounded-2xl">
    ...
    return (
        <div className="h-full w-full overflow-y-auto scrollbar-thin scrollbar-thumb-gray-700 scrollbar-track-gray-900 bg-transparent shadow-inner">
            {sessionType === 'chat' ? (
                <UserMessages
